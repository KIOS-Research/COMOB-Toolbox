...
%                 IsolationDecision(IndexZones(i))=1;
                handles.B.clr{IndexZones(i)} = [153/255 255/255 51/255];
            end
        end
        axes(handles.MainGuiaxes1)
        plotB(handles.B.X,handles.MainGuiaxes1,handles.B.LevelCounter,zeros(1,handles.B.nZones),handles.B.clr,handles.B.WindDirection,handles.B.C,handles.ZoneID,handles.PathID);
        axis on
