...
% pp=get(handles.panel, 'Children');
% if pp   
%     delete(get(handles.panel, 'Children'))
% end
...
% slider_lower_side=0.026936026936026942;
% slider_lower_side=0.0286;
%
...
%
% slider_x=get(handles.slider_x,'Position');
