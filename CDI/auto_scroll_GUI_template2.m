function varargout = auto_scroll_GUI_template2(varargin)
...
% AUTO_SCROLL_GUI_TEMPLATE2 MATLAB code for auto_scroll_GUI_template2.fig
%      AUTO_SCROLL_GUI_TEMPLATE2, by itself, creates a new AUTO_SCROLL_GUI_TEMPLATE2 or raises the existing
%      singleton*.
%
%      H = AUTO_SCROLL_GUI_TEMPLATE2 returns the handle to a new AUTO_SCROLL_GUI_TEMPLATE2 or the handle to
%      the existing singleton*.
%
%      AUTO_SCROLL_GUI_TEMPLATE2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in AUTO_SCROLL_GUI_TEMPLATE2.M with the given input arguments.
%
%      AUTO_SCROLL_GUI_TEMPLATE2('Property','Value',...) creates a new AUTO_SCROLL_GUI_TEMPLATE2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before auto_scroll_GUI_template2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to auto_scroll_GUI_template2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help auto_scroll_GUI_template2

% Last Modified by GUIDE v2.5 04-Dec-2013 16:14:17

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @auto_scroll_GUI_template2_OpeningFcn, ...
                   'gui_OutputFcn',  @auto_scroll_GUI_template2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before auto_scroll_GUI_template2 is made visible.
function auto_scroll_GUI_template2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to auto_scroll_GUI_template2 (see VARARGIN)

% Choose default command line output for auto_scroll_GUI_template2
...
% UIWAIT makes auto_scroll_GUI_template2 wait for user response (see UIRESUME)
...
function varargout = auto_scroll_GUI_template2_OutputFcn(hObject, eventdata, handles) 
