function varargout = auto_scroll_GUI_template5(varargin)
...
% AUTO_SCROLL_GUI_TEMPLATE5 MATLAB code for auto_scroll_GUI_template5.fig
%      AUTO_SCROLL_GUI_TEMPLATE5, by itself, creates a new AUTO_SCROLL_GUI_TEMPLATE5 or raises the existing
%      singleton*.
%
%      H = AUTO_SCROLL_GUI_TEMPLATE5 returns the handle to a new AUTO_SCROLL_GUI_TEMPLATE5 or the handle to
%      the existing singleton*.
%
%      AUTO_SCROLL_GUI_TEMPLATE5('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in AUTO_SCROLL_GUI_TEMPLATE5.M with the given input arguments.
%
%      AUTO_SCROLL_GUI_TEMPLATE5('Property','Value',...) creates a new AUTO_SCROLL_GUI_TEMPLATE5 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before auto_scroll_GUI_template5_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to auto_scroll_GUI_template5_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help auto_scroll_GUI_template5

% Last Modified by GUIDE v2.5 11-Dec-2013 11:51:12

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @auto_scroll_GUI_template5_OpeningFcn, ...
                   'gui_OutputFcn',  @auto_scroll_GUI_template5_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before auto_scroll_GUI_template5 is made visible.
function auto_scroll_GUI_template5_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to auto_scroll_GUI_template5 (see VARARGIN)

% Choose default command line output for auto_scroll_GUI_template5
...
% UIWAIT makes auto_scroll_GUI_template5 wait for user response (see UIRESUME)
...
function varargout = auto_scroll_GUI_template5_OutputFcn(hObject, eventdata, handles) 
