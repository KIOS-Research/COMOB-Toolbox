...
%}
function dx = IsolationObserverD(t, x, A, L, C, H, nZones, ysen, yint, time, GAMMA, B, Fj, nsources)

y = interp1q(time',ysen',t);
yi= interp1q(time',yint',t);
...
dx(1:nZones) = (A - L*C)*x(1:nZones) + L*y' ...
               + W*dx((nZones + nsources*nZones+1):(nZones + nsources*nZones+nsources)) ...
               + B*Fj*x((nZones + nsources*nZones+1):(nZones + nsources*nZones+nsources))...
               + H*yi';
